...
Staggered: Staggered.o mersenne_inline.o fermion_matrix.o worm_update.o local_update.o $(DEPS)
	$(CC) -o Staggered Staggered.o mersenne_inline.o fermion_matrix.o worm_update.o local_update.o  $(CFLAGS)
